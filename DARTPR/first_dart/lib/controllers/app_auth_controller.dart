...
import 'package:first_dart/model/model_response.dart';
import 'package:first_dart/model/user.dart';
import 'package:first_dart/utils/app_utils.dart';
...
class AppAuthController extends ResourceController{
  ...
  Future<Response> signUp(@Bind.body() User user) async {
    if (user.password == null || user.userName == null || user.email == null){
      return Response.badRequest(
        body: 
            ModelResponse(message: 'Поля password email и username обязательны'),
      );
    }
